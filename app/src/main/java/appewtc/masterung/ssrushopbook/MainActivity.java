...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String urlJSON = "http://swiftcodingthai.com/ssru/get_user_satien.php";
    ...
    private void checkUserAnPassword() {
        ...
        try {
            ...
            if(passwordString.equals(loginString[4])) {
                ...
                //password Flase
                MyAlert myAlert = new MyAlert();
                myAlert.myDialog(this, "Password Flase","Please Try Again Password False");
